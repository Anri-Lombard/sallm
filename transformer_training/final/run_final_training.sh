...
CHECKPOINT_DIR="/scratch/lmbanr001/masters/sallm/trained_models/final/checkpoints_bash_$(date +%Y%m%d_%H%M%S)" # Directory to save models
SAVE_EPOCHS="10,20,30,40,60"                                                                                   # Epochs to force save
SAVE_BEST_CHECKPOINT_FLAG="--save_best_checkpoint"                                                             # Include the flag to enable best saving
