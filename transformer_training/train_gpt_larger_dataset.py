...
class Hyperparameters:
    # data
    train_files = "/scratch/lmbanr001/masters/dataset/filtered_data_binary/custom_train_*.bin"  # input .bin to train on
    val_files = "/scratch/lmbanr001/masters/dataset/filtered_data_binary/custom_val_*.bin"  # input .bin to eval validation loss on
    val_tokens = (
        1_134_712_035 // 8192
    ...
    train_tokens = (4537874966 // 8192) * 8192
    num_iterations = (train_tokens * 3) // (
        64 * 1024
    )  # for 3 epochs TODO: with synthetic data
    cooldown_frac = 0.4  # fraction of training spent cooling down the learning rate
    # evaluation and logging
    val_loss_every = (
        10000  # every how many steps to evaluate val loss? 0 for only at the end
    )
    # implementation
